# (PART) Diari classe Teoria {-}

```{r child = '_header.Rmd'}
```

# Teoria Setmana 1 (2020-01-13)
...
- El [PDA](data/PDAmetodesM2021.pdf)
...
Veure [exemple](https://griu.github.io/meacp_2021/www/web/M2021Diari.html#qqplot-de-normalitat-per-les-notes-de-les-paau) enllaç.
